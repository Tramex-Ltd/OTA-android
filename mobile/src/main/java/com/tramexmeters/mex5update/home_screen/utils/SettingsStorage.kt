package com.tramexmeters.mex5update.home_screen.utils
...
class SettingsStorage(context: Context) {
    ...
    companion object {
        private const val PREFS_SETTINGS_STORAGE = "com.siliconlabs.mex5update.PREFS_SETTINGS_STORAGE"
        private const val KEY_SCAN_TIMEOUT = "com.siliconlabs.mex5update.KEY_SCAN_TIMEOUT"
