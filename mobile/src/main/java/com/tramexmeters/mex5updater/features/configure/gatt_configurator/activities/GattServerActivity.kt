package com.tramexmeters.mex5updater.features.configure.gatt_configurator.activities
...
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.adapters.EditGattServerAdapter
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.adapters.EditGattServerAdapter.AddServiceListener
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.adapters.EditGattServerAdapter.ServiceListener
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.dialogs.LeaveGattServerConfigDialog
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.dialogs.ServiceDialog
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.dialogs.ServiceDialog.ServiceChangeListener
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.models.GattServer
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.models.Service
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.utils.GattConfiguratorStorage
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.utils.removeAsking
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.viewmodels.GattServerViewModel
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.viewmodels.GattServerViewModel.Validation
import com.tramexmeters.mex5updater.common.other.EqualVerticalItemDecoration
