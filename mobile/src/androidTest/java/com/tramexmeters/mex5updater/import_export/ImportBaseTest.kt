...
import com.tramexmeters.mex5updater.features.configure.gatt_configurator.import_export.utils.XmlPrinter
...
open class ImportBaseTest {
    ...
    companion object {
        private val filePath = File("data/data/com.siliconlabs.mex5updater/example.xml")
