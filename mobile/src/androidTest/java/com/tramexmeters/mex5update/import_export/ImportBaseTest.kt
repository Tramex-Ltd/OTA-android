...
import com.tramexmeters.mex5update.features.configure.gatt_configurator.import_export.*
...
open class ImportBaseTest {
    ...
    companion object {
        private val filePath = File("data/data/com.siliconlabs.mex5update/example.xml")
